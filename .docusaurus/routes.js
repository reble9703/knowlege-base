        ...
        routes: [
          {
            ...
            routes: [
              {
                path: '/docs/ai-applications/intro',
                component: ComponentCreator('/docs/ai-applications/intro', '8eb'),
                exact: true,
                sidebar: "aiSidebar"
              },
              {
                path: '/docs/finance-freedom/intro',
                component: ComponentCreator('/docs/finance-freedom/intro', '57d'),
                exact: true,
              ...
              {
                path: '/docs/product-structure/intro',
                component: ComponentCreator('/docs/product-structure/intro', '60b'),
                exact: true,
                sidebar: "productStructureSidebar"
              },
              {
                path: '/docs/time-management/intro',
                component: ComponentCreator('/docs/time-management/intro', 'c66'),
                exact: true,
                sidebar: "timeSidebar"
              },
              {
